  ...
  [9514, 2006],
  {
    231: (e, t, n) => {
      ...
      var a = n(2784),
        ...
        b = n(4126),
        p = n(2105);
      const h = "backToTopButton_z1FD",
        v = "backToTopButtonShow_w1wE";
      function f() {
        var e = (function (e) {
            var t = e.threshold,
              n = (0, a.useState)(!1),
      ...
      const N = "collapseSidebarButton_Ftvb",
      ...
      function Z(e) {
        ...
        return a.createElement(
          "button",
          {
            ...
            className: (0, r.Z)("button button--secondary button--outline", N),
            onClick: t,
          },
          a.createElement(I, { className: S })
        );
      }
      var x = n(3717),
        T = n(1461),
      ...
      function F(e) {
        ...
        return a.createElement(L.Provider, { value: i }, t);
      }
      var A = n(7661),
        M = n(8698),
        P = n(9817),
        B = n(9741),
        H = ["item", "onItemClick", "activePath", "level", "index"];
      function W(e) {
      ...
      function D(e) {
        var t = e.item,
          ...
          p = t.className,
          h = t.href,
          v = (0, k.L)().docs.sidebar.autoCollapseCategories,
          f = (function (e) {
            var t = (0, B.Z)();
            return (0, a.useMemo)(
              function () {
          ...
          S = (function () {
            ...
            if (e === w) throw new y.i6("DocSidebarItemsExpandedStateProvider");
            return e;
          })(),
          Z = S.expandedItem,
          x = S.setExpandedItem,
          F = function (e) {
            void 0 === e && (e = !I), x(e ? null : s), N(e);
          };
        return (
          (function (e) {
            var t = e.isActive,
          ...
          })({ isActive: E, collapsed: I, updateCollapsed: F }),
          (0, a.useEffect)(
            function () {
              b && Z && Z !== s && v && N(!0);
            },
          ...
          a.createElement(
            ...
            {
              className: (0, r.Z)(
                c.k.docs.docSidebarItemCategory,
                c.k.docs.docSidebarItemCategoryLevel(o),
                "menu__list-item",
            ...
            a.createElement(
              "div",
              {
                className: (0, r.Z)("menu__list-item-collapsible", {
            ...
            a.createElement(
              M.z,
              { lazy: !0, as: "ul", className: "menu__list", collapsed: I },
              a.createElement(X, {
                items: m,
                tabIndex: I ? -1 : 0,
                onItemClick: n,
      ...
      var q = n(1344),
        R = n(2007);
      const z = "menuExternalLink_xK2O";
      var O = ["item", "onItemClick", "activePath", "level", "index"];
      function K(e) {
        var t = e.item,
          n = e.onItemClick,
          i = e.activePath,
        ...
        return a.createElement(
          ...
          {
            className: (0, r.Z)(
              c.k.docs.docSidebarItemLink,
              c.k.docs.docSidebarItemLinkLevel(o),
              "menu__list-item",
              u
            ),
            key: m,
          ...
          a.createElement(
            ...
            (0, C.Z)(
              {
                className: (0, r.Z)("menu__link", !p && z, {
                  "menu__link--active": b,
                }),
            ...
            m,
            !p && a.createElement(R.Z, null)
          )
        );
      }
      const V = "menuHtmlItem_anEq";
      function U(e) {
        var t = e.item,
          n = e.level,
          l = e.index,
        ...
        return a.createElement("li", {
          className: (0, r.Z)(
            c.k.docs.docSidebarItemLink,
            c.k.docs.docSidebarItemLinkLevel(n),
            o && [V, "menu__list-item"],
            s
          ),
          key: l,
      ...
      function J(e) {
        ...
        switch (t.type) {
          ...
          default:
            return a.createElement(K, (0, C.Z)({ item: t }, n));
        }
      }
      var G = ["items"];
      function Q(e) {
      ...
      function ee(e) {
        ...
        return a.createElement(
          "nav",
          { className: (0, r.Z)("menu thin-scrollbar", j, i && $, l) },
          a.createElement(
            "ul",
            { className: (0, r.Z)(c.k.docs.docSidebarMenu, "menu__list") },
            a.createElement(X, { items: n, activePath: t, level: 1 })
          )
        );
      }
      const te = "sidebar_vJCc",
        ne = "sidebarWithHideableNavbar_Fo4g",
        ae = "sidebarHidden_vBKa",
        re = "sidebarLogo_nlll";
      function le(e) {
        var t = e.path,
          n = e.sidebar,
          ...
          s = o.docs.sidebar.hideable;
        return a.createElement(
          "div",
          { className: (0, r.Z)(te, c && ne, i && ae) },
          c && a.createElement(_.Z, { tabIndex: -1, className: re }),
          a.createElement(ee, { path: t, sidebar: n }),
          s && a.createElement(Z, { onClick: l })
        );
      }
      const ie = a.memo(le);
      var oe = n(7136),
      ...
      function de(e) {
        return a.createElement(ce.Zo, { component: se, props: e });
      }
      const me = a.memo(de);
      function ue(e) {
        var t = (0, g.i)(),
      ...
      const be = "expandButton_qIqc",
        pe = "expandButtonIcon_aOpf";
      function he(e) {
      ...
      const ve = "docSidebarContainer_aIKW",
        fe = "docSidebarContainerHidden_UIq3";
      function Ee(e) {
        var t,
          n = e.children,
          r = (0, d.V)();
        return a.createElement(
          a.Fragment,
          { key: null != (t = null == r ? void 0 : r.name) ? t : "noSidebar" },
          n
        );
      }
      function ge(e) {
        ...
        return a.createElement(
          "aside",
          {
            className: (0, r.Z)(c.k.docs.docSidebarContainer, ve, n && fe),
            onTransitionEnd: function (e) {
              e.currentTarget.classList.contains(ve) && n && d(!0);
            },
          },
          a.createElement(
            Ee,
          ...
          s && a.createElement(he, { toggleSidebar: m })
        );
      }
      const ke = {
      ...
      function _e(e) {
        ...
        return a.createElement(
          "main",
          {
            className: (0, r.Z)(
              ke.docMainContainer,
              (t || !l) && ke.docMainContainerEnhanced
            ),
          },
          a.createElement(
            "div",
      ...
      function xe(e) {
        ...
        return a.createElement(
          ...
          a.createElement(Ze.Z, {
            version: t.version,
            tag: (0, i.os)(t.pluginId, t.version),
          }),
          a.createElement(
            o.FG,
            {
              className: (0, r.Z)(
                c.k.wrapper.docsPages,
                c.k.page.docsDocPage,

...
type TypeOfPropertyType = PropertyType<Node, 'type'>;
export type TBABEL_PARSER_AST_NODE_TYPES = { [k in TypeOfPropertyType]: k }
/** This support Node types that do exist in legacy parsers, although in the context of typescript it should not matter */
export const BABEL_PARSER_AST_NODE_TYPES: TBABEL_PARSER_AST_NODE_TYPES = {

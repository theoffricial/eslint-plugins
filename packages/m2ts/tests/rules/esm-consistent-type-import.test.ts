import rule from "../../src/rules/esm-consistent-type-import";
import { RuleTester, noFormat, getFixturesRootDir } from "../rule-tester";
...
ruleTester.run("esm-consistent-type-import", rule, {
  valid: [
    `
      import Foo from 'foo';
